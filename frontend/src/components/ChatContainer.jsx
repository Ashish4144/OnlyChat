...
import { formatMessageTime } from "../request/utils";
          ...
          <div
            ...
            <div className=" chat-image avatar">
              <div className="size-10 rounded-full border">
                <img
                  src={
                    message.senderId === authUser._id ? authUser.profilePic || "/image.png": selectedUsers.profilePic || "/image.png"
                  }
                  alt="profile pic"/>
              </div>
            </div>
